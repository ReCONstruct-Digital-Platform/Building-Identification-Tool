...
class MyTests(TestCase):
    ...
    def setUp(self):
        ...
        self.eval_unit2 = EvalUnit.objects.create(id='id2', lat=1.0, lng=1.5, muni='mtl',year=2005, address='4656 a st', mat18='fsdfsd', cubf=1000, const_yr = 1234, associated={'hlm': ['hlm1']})
        self.form_data = {
